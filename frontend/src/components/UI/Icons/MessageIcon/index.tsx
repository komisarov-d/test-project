...
const CalendarIcon: FunctionComponent<IconContainerProps> = ({ ...iconContainerProps }) => {
	return (
		<IconContainer size="md" {...iconContainerProps}>
			<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 217.762 217.762">
				<path
					fill="white"
